				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<div class="table-box">
							...
							<form id="form1" action="${pageContext.servletContext.contextPath}/permission/delete.do" method="post">
								<!--数据列表-->
								<table id="dataList"
									...
									<tbody>
										...
										<c:forEach items="${pageInfo.list}" var="permission">
											<tr>
												...
												<td><input type="checkbox" name="selectIds" value="${permission.id}"></td>
												<td>${permission.id }</td>
												<td>${permission.permissionName }</td>
												<td>${permission.url }</td>
												<td class="text-center">
													<a href="${pageContext.request.contextPath}/permission/edit.do?id=${permission.id}" class="btn bg-olive btn-xs">编辑</a>
					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								<li><a aria-label="Previous" href="${pageContext.request.contextPath}/permission/findAll.do?page=1&pageSize=${pageInfo.pageSize}">首页</a></li>
								...
								<c:forEach begin="1" end="${pageInfo.pages}" var="i">
									<c:if test="${i==pageInfo.pageNum}">
										<li><a style="background-color: #2aabd2" href="${pageContext.request.contextPath}/permission/findAll.do?page=${i}&pageSize=${pageInfo.pageSize}">${i}</a></li>
									</c:if>
									<c:if test="${i!=pageInfo.pageNum}">
										<li><a href="${pageContext.request.contextPath}/permission/findAll.do?page=${i}&pageSize=${pageInfo.pageSize}">${i}</a></li>
									</c:if>
								</c:forEach>
