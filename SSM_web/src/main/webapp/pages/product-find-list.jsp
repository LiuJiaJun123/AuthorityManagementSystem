                    ...
                    <div class="table-box">
                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="新建" onclick="window.location.href='${pageContext.request.contextPath}/pages/product-add.jsp'"><i class="fa fa-file-o"></i> 新建</button>
                        ...
                        <div class="box-tools pull-right">
                            ...
                            <form action="${pageContext.request.contextPath}/product/findProduct.do" method="post">
                                <div class="has-feedback">
                                    <%--搜索--%>
                                    <input type="text" class="form-control input-sm" placeholder="输入产品名称搜索" name="productName" id="productName" value="${findName}">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button type="button" class="btn bg-olive btn-xs"
                                                    onclick='location.href="${pageContext.request.contextPath}/product/update.do?id=${product.id}"'>编辑</button>
                                        </td>
